 ...
 */
    [_COLEMAK_DH] = LAYOUT(
     ...
     NAV     , KC_Z   , KC_X   , KC_C   , KC_D   , KC_V   , KC_LBRC, KC_ENT , FKEYS , KC_RBRC, KC_K  , KC_H   , KC_COMM, KC_DOT , KC_SLSH,  KC_ENT ,
                                 ADJUST , NUM    , KC_SPC , KC_SPC , CODE   , KC_ENT, KC_RALT, SYM   , FKEYS  , KC_LGUI
    ),
    ...
    [_NUM] = LAYOUT(
      ...
      _______, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, _______,                                     KC_P4, KC_P5, KC_P6, _______, KC_PLUS,  KC_DEL,
